...
\affil[1,2,3]{\small  Escuela de Ingenieria,Universidad de los Andes\\
\texttt{{a.blanco,a.calderon,c.barreto805}@uniandes.edu.co}}
\affil[1,2,3]{\small Herramientas Computacionales\\
Bogota\\
\texttt{delcurso@bp.com.co}}
...
%ColREsIdx@data traer el mapa con estas columnas
% todo lo que no sea la fila 1 convierta en ordinal
%row.names numero de ejecuci??n, lo forzo para que sea el pa??s
%pam_fit <- pam(dist, diss = TRUE, k = 3) % todos los paises los organice en 3 grupos
